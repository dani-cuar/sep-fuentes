...
def recortar_archivo(path, name, name):
    ...
    nombre_original = os.path.basename(path).split('.')[0].split('.')[0]
...
def sumar_audios(archivos_male, archivos_female):
    ...
    for audio_male_path, audio_female_path in zip(archivos_male, archivos_female):
        ...
        audio_male_recortado = recortar_archivo(audio_male_path, f"mf{contadormf:03d}", f"mf{contadormf:03d}") # devuelve la ruta del archivo recortado
        audio_female_recortado = recortar_archivo(audio_female_path, f"mf{contadormf:03d}", f"mf{contadormf:03d}")
        ...
        # Sumar los audios //constant energy pan //constant energy pan
...
lista_archivos = list_files_in_folder(ruta_carpeta)
